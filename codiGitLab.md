...
* **Gestión de Repositorios Git:** Al igual que GitHub, es un servicio basado en la web para repositorios Git.
* **Integración Continua y Entrega Continua (CI/CD):** Su principal fortaleza es el sistema de CI/CD integrado y altamente configurable, que permite automatizar las pruebas y el despliegue del código.
* **DevOps Completo:** Cubre todas las etapas de la metodología DevOps:
    * **Plan:** Gestión de proyectos, tableros Kanban e *Issue Tracking*.
    * **Create:** Revisión de código y Merge Requests.
    * **Verify:** CI (pruebas automatizadas).
    * **Package:** Registro de contenedores y paquetes.
    * **Secure:** Escaneo de vulnerabilidades.
    * **Release:** CD (despliegue automatizado).
